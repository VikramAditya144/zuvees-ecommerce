 ...
 *   get:
 *     summary: Get all approved emails
 *     tags: [Admin]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: List of approved emails
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: array
 *                   items:
 *                     $ref: '#/components/schemas/ApprovedEmail'
 *                 meta:
 *                   type: object
 *                   properties:
 *                     page:
 ...
 *                   $ref: '#/components/schemas/ApprovedEmail'
 *       400:
 *         description: Invalid request data or email already approved
 *       401:
 *         $ref: '#/components/responses/UnauthorizedError'
 *       403:
 *         $ref: '#/components/responses/ForbiddenError'
 ...
 *         description: Server error
 * 
 * /admin/approved-emails/{id}:
 *   delete:
 *     summary: Remove approved email
 *     tags: [Admin]
 *     security:
 *       - bearerAuth: []
 *     parameters:
